...
<div style="text-align: center;">
    ...
    <div
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Username" aria-label="Username" id="UIDD"
                oninput="getUID()">
    ...
    <div
        ...
        <div class="btn-group" style="margin-bottom: 10px; max-width: 46%;">
            <button type="button" onclick="beliSekarang()" class="btn product-button" data-harga="{{ $p->harga }}"
                ...
                <img src="img/dmm.png" alt="Product Image" style="max-width: 75%; height: auto; margin-right: 5px;">
                {{ $p->nama_produk }}
            </button>
        </div>
        @endforeach
        ...
        <div
            ...
            <img src="img/bundleml.png" alt="Icon" style="width: 70px; height: 70px; margin-right:10px; margin-left: 0px;">
            <span style="font-size: 1.275rem; text-align: left; margin-bottom: 0;">Bundle</span>
        </div>
        <p style="color: #17232f; margin-top: 30px;">Pilih items</p>
        <p style="color: #17232f; font-size: .750rem; margin-top: -15px;">*Klik Item 2 kali</p>
        @foreach($produks_bundle as $a)
        <div class="btn-group" style="margin-bottom: 10px; max-width: 46%;">
            <button type="button" onclick="beliSekarang()" class="btn product-button" data-harga="{{ $a->harga }}"
                ...
                <img src="img/dmm.png" alt="Product Image" style="max-width: 50%; height: auto; margin-right: 5px;">
                {{ $a->nama_produk }}
            </button>
        </div>
        @endforeach
